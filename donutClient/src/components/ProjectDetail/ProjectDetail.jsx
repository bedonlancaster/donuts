...
const getThemePreview = (mode, palette) => {
  return COLOR_PALETTES[palette]
    ? COLOR_PALETTES[palette][mode.toLowerCase()]
    : COLOR_PALETTES.Coral.light;
};
    ...
    return (
      <div className="project-detail">
        <div className="loading-state fullscreen">
          <div className="loading-message-theme">Loading project...</div>
        </div>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      >
        {/* Tabs Navigation */}
        <div
          className="project-tabs-inline"
          style={{ borderBottom: `2px solid ${activeTheme.primary}` }}
        >
          <button
            ...
            style={{
              color:
                activeTab === 'tracks' ? activeTheme.primary : activeTheme.text,
              borderBottom:
                activeTab === 'tracks'
                  ? `2px solid ${activeTheme.primary}`
                  : 'none',
            }}
          >
            Tracks
        ...
        <div className="user-profile">
          ...
          <div className="profile-info">
            <div className="profile-name" style={{ color: activeTheme.text }}>
              {user.username}
            </div>
                  ...
                  >
                    ...
                    <div className="track-info">
                      <h4
                        ...
                        onClick={() =>
                          navigate(
                            `/project/${projectId}/track/${track.id}?tab=hitlist`
                          )
                        }
                      ...
                      <p className="track-artist">
                        {project.artistName || track.uploadedBy.username}
                      </p>
                    </div>
                    ...
                    >
                      <span
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          setOpenRoleDropdown(
                            openRoleDropdown === index ? null : index
                          );
                        }}
                      ...
                      {openRoleDropdown === index && (
                        <div className="role-dropdown">
                          {Object.entries(COLLABORATOR_ROLES).map(
                            ([roleValue, roleInfo]) => (
                              <div
                                key={roleValue}
            ...
            <div className="settings-content">
              ...
              <div className="setting-group">
                ...
                >
                  <strong style={{ color: activeTheme.primary }}>
                    {themePreview
                      ? `${themePreview.palette} - ${themePreview.mode} Mode`
                      : 'Loading theme...'}
                  </strong>
                  <p style={{ margin: '0.5rem 0', fontSize: '0.9rem' }}>
                    This is how your project theme will look with text and
                    backgrounds.
                  </p>
                </div>
                  ...
                  >
                    ...
                    <label className="switch">
                      <input
                        ...
                        onChange={(e) =>
                          handleProjectThemeMode(e.target.checked)
                        }
                      />
                ...
                <button
                  ...
                  onClick={async () => {
                    try {
                      ...
                      alert(
                        `Updated ${result.updated} tracks, ${result.failed} failed`
                      );
              ...
              <div className="setting-group">
                ...
                <p style={{ marginBottom: '1rem', color: '#e74c3c' }}>
                  Deleting this project will permanently remove all tracks,
                  collaborators, and data. This action cannot be undone.
                </p>
                <button
