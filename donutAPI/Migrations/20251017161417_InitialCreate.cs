        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColorTheme = table.Column<string>(type: "character varying(7)", maxLength: 7, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sessions_AspNetUsers_ArtistId",
                        column: x => x.ArtistId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Sessions_AspNetUsers_BookedById",
                        column: x => x.BookedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Sessions_AspNetUsers_ProducerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HitListItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HitListItems_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HitListItems_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HitListItems_Tracks_TrackId",
                        column: x => x.TrackId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HitListItems_CreatedById",
                table: "HitListItems",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_HitListItems_ProjectId",
                table: "HitListItems",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_HitListItems_TrackId",
                table: "HitListItems",
                column: "TrackId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sessions_BookedById",
                table: "Sessions",
                column: "BookedById");

            migrationBuilder.CreateIndex(
                name: "IX_Sessions_ProducerId",
                table: "Sessions",
                column: "ProducerId");
