...
namespace DonutAPI.Migrations
{
    ...
    [Migration("20260103235526_AddTrackVersioning")]
    partial class AddTrackVersioning
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DonutAPI.Models.TrackVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TrackId", "IsCurrentVersion")
                        .HasFilter("[IsCurrentVersion] = 1");

                    b.HasIndex("TrackId", "VersionNumber")
                        .IsUnique();

                    b.ToTable("TrackVersions");
                });
            ...
            modelBuilder.Entity("DonutAPI.Models.TrackVersion", b =>
                {
                    ...
                    b.HasOne("DonutAPI.Models.User", "UploadedBy")
                        .WithMany("UploadedTrackVersions")
            ...
            modelBuilder.Entity("DonutAPI.Models.User", b =>
                {
                    ...
                    b.Navigation("UploadedTrackVersions");
                });
